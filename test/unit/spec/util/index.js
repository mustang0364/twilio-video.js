...
const {
  makeUnderscorePrefixedPropertiesNonEnumerable,
  makeUnderscorePrefixedPropertiesSetByConstructorNonEnumerable,
  makeUUID,
  promiseFromEvents
} = require('../../../../lib/util');

describe('util', () => {
  describe('makeUnderscorePrefixedPropertiesNonEnumerable', () => {
    it('should do what it says', () => {
      const object = { foo: 'bar', _baz: 'qux' };
      assert.deepEqual(Object.keys(object), ['foo', '_baz']);
      makeUnderscorePrefixedPropertiesNonEnumerable(object);
      assert.deepEqual(Object.keys(object), ['foo']);
    });
  });

  describe('makeUnderscorePrefixedPropertiesSetByConstructorNonEnumerable', () => {
    it('should do what it says', () => {
      class Foo1 {
        constructor() {
      ...
      const Foo2 = makeUnderscorePrefixedPropertiesSetByConstructorNonEnumerable(Foo1);
