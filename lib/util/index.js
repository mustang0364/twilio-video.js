 ...
 * @returns {void}
 */
function makeUnderscorePrefixedPropertiesNonEnumerable(object) {
 ...
 */
function makeUnderscorePrefixedPropertiesSetByConstructorNonEnumerable(klass) {
  // NOTE(mroberts): We do this to avoid giving the class a name.
  return class extends klass {
    constructor(...args) {
      super(...args);
      makeUnderscorePrefixedPropertiesNonEnumerable(this);
    }
  };
}
...
exports.makeUnderscorePrefixedPropertiesNonEnumerable = makeUnderscorePrefixedPropertiesNonEnumerable;
exports.makeUnderscorePrefixedPropertiesSetByConstructorNonEnumerable = makeUnderscorePrefixedPropertiesSetByConstructorNonEnumerable;
